...
<header class="br-header"><div class="br-shell br-nav"><a class="br-brand" href="../index.html" aria-label="Rodada a Rodada — página inicial"><span>R/R</span><strong>Rodada a Rodada</strong></a><nav aria-label="Navegação principal"><a href="../brasileirao/classificacao-rodada-a-rodada.html">Brasileirão</a><a href="#grupos">Grupos</a><a href="#mata-mata">Mata-mata</a><a href="#jogos">Jogos</a><a href="#artilharia">Artilharia</a><a href="#participantes">Times</a><a href="../projetos.html">Portfólio</a></nav></div></header>
